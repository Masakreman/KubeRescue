...
import (
	...
	"github.com/Masakreman/KubeRescue/internal/controller"
...
func main() {
	...
	if err = (&controller.LogRemediationReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "LogRemediation")
		os.Exit(1)
	}
